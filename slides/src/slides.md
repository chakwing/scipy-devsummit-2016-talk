...
![](images/logos/matplotlib.png) {data-background="images/bg-7.png"}
--------------------------------
...
![](images/logos/sympy.png) {data-background="images/bg-7.png"}
---------------------------
...
New to Python {data-background="images/bg-3.png"}
-------------
